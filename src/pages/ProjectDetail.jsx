            ...
            <div className="grid md:grid-cols-2 gap-6 pt-4">
              {project.technologies && (
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm font-light tracking-wide uppercase text-muted-foreground"><Code className="size-4" /><span>Technologies</span></div>
