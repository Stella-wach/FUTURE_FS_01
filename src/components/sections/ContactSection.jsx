        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.5, delay: 0.2 }} className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4"><Mail className="size-5 text-primary mt-1" /><div><p className="font-semibold">Email</p><a href={`mailto:${photographerInfo.email}`} className="text-muted-foreground hover:text-primary transition-colors">{photographerInfo.email}</a></div></div>
              <div className="flex items-start gap-4"><Phone className="size-5 text-primary mt-1" /><div><p className="font-semibold">Phone</p><a href={`tel:${photographerInfo.phone}`} className="text-muted-foreground hover:text-primary transition-colors">{photographerInfo.phone}</a></div></div>
              <div className="flex items-start gap-4"><MapPin className="size-5 text-primary mt-1" /><div><p className="font-semibold">Location</p><p className="text-muted-foreground">{photographerInfo.location}</p></div></div>
            </div>
          ...
          <motion.form onSubmit={handleSubmit} initial={{ opacity: 0, x: 20 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.5, delay: 0.3 }} className="space-y-5">
            <div>
            ...
            <button type="submit" disabled={sending} className="inline-flex items-center gap-2 px-6 py-3 btn-gradient rounded-lg font-medium disabled:opacity-50">
